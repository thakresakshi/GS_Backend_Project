...
public class hodDB {
	...
	public hodDB(String grievanceId, Date date, String fullName, String email, String mobile, String tehsil,
			String village, String address, int aadharNo, String grievance, String status, String forwardedToDept,
			String emp, String otherDept) {
		super();
	...
	public String toString() {
		return "hodDB [grievanceId=" + grievanceId + ", date=" + date + ", fullName=" + fullName + ", email=" + email
				...
				+ forwardedToDept + ", emp=" + emp + ", otherDept=" + otherDept + "]";
	}
